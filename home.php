                ...
                <div class="container">
                    <div class="row justify-content-center">
                        <div class="col-lg-6 text-center">
                            <h2 data-aos="fade-down">Welcome to <span>DAILYCOLLECT</span></h2>                                                                                                <!--data-aos="fade-up/down" is to make things display upwards or downwards-->
                            <p data-aos="fade-up">DAILYCOLLECT IS  AN  APPLICATION  PLATFORM  WHICH  HELPS  TO  FACILITATE  THE  TRANSACTION  PROCESS  BETWEEN  CONTRIBUTORS  AND  COLLECTORS  IN  A  SECURED  AND  EFFICIENT  WAY. </p>
