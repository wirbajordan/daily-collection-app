...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $role = "collector"; // Default role for this form
...
<head>
    ...
    <style>
        ...
        .add-user-form .card-header h2 {
            margin: 0 !important;
            font-weight: 600 !important;
            font-size: 1.5rem !important;
        }
        .add-user-form .card-body {
        ...
        .add-user-form .form-control.is-invalid {
            border-color: #dc3545 !important;
        }
        .add-user-form .invalid-feedback {
        ...
        .add-user-form .input-group-text {
            background-color: #f8f9fa;
            border: 2px solid #e9ecef;
            border-right: none;
            color: #6c757d;
        }
        .add-user-form .input-group .form-control {
            border-left: none;
        }
        .add-user-form .input-group .form-control:focus {
            border-left: none;
        }
    </style>
</head>
<body class="add-user-form">
    <div class="wrapper">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <p class="text-muted mb-4">Please fill in the details below to add a new collector to the system.</p>
                ...
                <form action="<?php echo htmlspecialchars(basename($_SERVER['REQUEST_URI'])); ?>" method="post">
                    ...
                    <div class="text-center mt-4">
                        <input type="submit" class="btn btn-success" value="Add Collector">
                        <a href="admin.php?q=2&page=<?php echo base64_encode('../collector_list'); ?>" class="btn btn-secondary ml-3">Cancel</a>
                    </div>
                </form>
            </div>
        </div>
