...
<div class="panel"><table class="table table-striped title1"  style="vertical-align:middle">
        ...
        <a href="admin.php?q=2 & page=<?php echo base64_encode('ubpages/ubsettings/course/addCourse/addCourse'); ?>"class="btn btn-primary" style="margin-left:92%;">Add Collector +</a>
        ...
        while ($row = mysqli_fetch_array($result)) {     
            ...
            <tr><td style="vertical-align:middle"><?php echo'' . $c++ . '' ?></td>
                ...
                <td><a href='admin.php?q=2 & page=<?php echo base64_encode('ubpages/ubsettings/course/courseAjax'); ?>&course_name=<?php echo ''.$name.'' ?>' onclick="return(confirm('Are you sure to delete this collector ?'));" class="glyphicon glyphicon-trash" style="font-size:18px;padding:5px; color:red; "></a></td>
            </tr>
            <?php
   }
 ?>
